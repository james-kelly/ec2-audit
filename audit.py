...
for region in REGIONS:
    ...
    for reservation in reservations:
        ...
        for instance in instances:
            ...
            if instance.state == u'running' and uptime.seconds > 60 * 30 and 'application' not in tag_names:
                unclaimed_instances.append(instance)

for instance in sorted(unclaimed_instances, lambda a, b: cmp(parse(a.launch_time), parse(b.launch_time))):
